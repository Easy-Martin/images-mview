...
function ImageMobileView({
  ...
  }, imageList.map((v, i) => /*#__PURE__*/React.createElement("div", {
...
const ImageViewModal = function ({
  ...
  return /*#__PURE__*/ReactDOM.createPortal( /*#__PURE__*/React.createElement(QueueAnim, {
    type: "alpha"
  }, visible ? /*#__PURE__*/React.createElement(ImageMobileView, {
